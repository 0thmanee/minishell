...
final_cmd.c final_cmd_1.c final_cmd_2.c final_cmd_3.c final_cmd_4.c syntax_error.c check_braces.c ft_malloc.c

libft_files = ft_str_1.c ft_str_2.c ft_str_3.c ft_lst_1.c ft_lst_2.c ft_char.c ft_split.c ft_atoi.c whitespace_split.c
...
CFLAGS = -Wall -Werror -Wextra #-fsanitize=address -fsanitize=undefined -g
